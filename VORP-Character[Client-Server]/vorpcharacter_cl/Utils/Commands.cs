...
namespace VorpCharacter.Utils
{
    class Commands : BaseScript
    {
        ...
        public static void InitCommands()
        {
            ...
            API.RegisterCommand(Common.GetTranslation("Commandbow"), new Action(Bow), false);
            API.RegisterCommand(Common.GetTranslation("Commandarmor"), new Action(Armor), false);
            API.RegisterCommand(Common.GetTranslation("CommandCCoat"), new Action(CCoat), false); // closed coat as per config
        ...
        private static void Bow() => ToggleComponent(0x0662AC34, LoadPlayer.ConvertValue(LoadPlayer.cache_cloths["bow"].ToString()));
        private static void Armor() => ToggleComponent(0x0662AC34, LoadPlayer.ConvertValue(LoadPlayer.cache_cloths["armor"].ToString()));
        private static void CCoat() => ToggleComponent(0x0662AC34, LoadPlayer.ConvertValue(LoadPlayer.cache_cloths["CoatClosed"].ToString()));
        ...
        private static void Undress()
        {
            ...
            Utilities.RemoveTagFromMetaPed(playerPedId, 0x8E84A2AA, 0);
            Utilities.RemoveTagFromMetaPed(playerPedId, 0x662AC34, 0);
            Utilities.RemoveTagFromMetaPed(playerPedId, 0x72E6EF74, 0);
        }
        ...
        private static void Dress()
        {
            ...
            Utilities.ApplyShopItemToPed(playerPedId, LoadPlayer.ConvertValue(LoadPlayer.cache_cloths["armor"].ToString()), true, true, false);
            Utilities.ApplyShopItemToPed(playerPedId, LoadPlayer.ConvertValue(LoadPlayer.cache_cloths["bow"].ToString()), true, true, false);
        }
