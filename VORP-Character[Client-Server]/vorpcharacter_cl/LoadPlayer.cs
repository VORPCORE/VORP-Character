...
namespace vorpcharacter_cl
{
    public class LoadPlayer : BaseScript
    {
        public LoadPlayer()
        {
            ...
            EventHandlers["vorp:loadPlayerSkin"] += new Action<ExpandoObject, ExpandoObject>(loadPlayerSkin);
        }
...
/*
            Function.Call((Hash)0x5653AB26C82938CF, pPedID, 0xB6CE, skin.EarsW);
            ...
            Function.Call((Hash)0x5653AB26C82938CF, pPedID, 0x358D, skin.CheekBonesD);
            //Function.Call((Hash)0xCC8CA3E88256E58F, pPedID, 0, 1, 1, 1, false);
            ...
            Function.Call((Hash)0x5653AB26C82938CF, pPedID, 0x91C1, skin.ULiphW);
            //Function.Call((Hash)0xCC8CA3E88256E58F, pPedID, 0, 1, 1, 1, false);
